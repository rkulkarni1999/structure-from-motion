...
#     # #new change
#     # uv_X4 = uv_X4_set[best_i]
#     # pts1 = np.zeros((uv_X4.shape[0],2))
#     # pts2 = np.zeros((uv_X4.shape[0],2))
#     # X_filti = np.zeros((uv_X4.shape[0],3))
#     # for i in range(uv_X4.shape[0]):
#     #     print("euro8itfyhoisdhf")
#     #     if uv_X4[i][2, 2] >= 0:
#     #         filtered_array = uv_X4[i]
#     #         pts1[i] = filtered_array[:2,0]
#     #         pts2[i] = filtered_array[:2,1]
#     #         X_filti[i] = filtered_array[:,2]
