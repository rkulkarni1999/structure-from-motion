...
def test(hn, hf, dataset, chunk_size=10, img_index=0, nb_bins=192, H=400, W=400, data_flag="lego"):
    ...
    plt.close()
    print(f"Images no. {img_index} saved")
...
def train(nerf_model, optimizer, scheduler, data_loader, device='cpu', hn=0, hf=1, nb_epochs=int(3),nb_bins=192, H=400, W=400, checkpoint_dir="./rkulkarni1_p2/Phase2/checkpoints", data_flag="lego"):
...
if __name__ == '__main__':
    ...
    model = NerfModel_without_encoding(hidden_dim=64).to(device)
